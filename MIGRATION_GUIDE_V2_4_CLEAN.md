# Migration Guide: v2.3/v2.4 → v2.4-clean
...
Before deploying v2.4-clean in production:
...
**Solution:** Use `template_compliance_checker_v2_4_clean.py`

### Issue: Range checks showing FAIL instead of WARN

**Cause:** Using old checker or wrong comparison type  
**Solution:** Verify using v2.4-clean and `comparison: range`
...
**Note:** v2.4-clean is designed to be **forward-compatible only**. If you migrate your policy to new format, you'll need the v2.4-clean checker.
...
### Documentation Files
- `template_compliance_checker_v2_4_clean.py` - Main checker script
- `nxos_compliance_policy_v2_4_clean.yaml` - Sample policy file
- `MIGRATION_GUIDE_V2_4_CLEAN.md` - This document
- `USAGE_EXAMPLES_V2_4_CLEAN.md` - Usage examples
- `CHANGELOG_V2_4_CLEAN.md` - Detailed change log
...
# Use with new policy:
python template_compliance_checker_v2_4_clean.py config.txt --policy new_policy.yaml
...
✅ **v2.4-clean is 100% backward compatible**  
