#!/usr/bin/env python3
"""
Production-Quality Template Compliance Checker v2.5
==========================================================================
...
class ProductionComplianceChecker:
    ...
    def __init__(self, config_file: str, policy_file: str = None, verbose: bool = False):
        ...
        if policy_file is None:
            policy_file = Path(__file__).parent / "nxos_compliance_policy_v2.5.yaml"
    ...
    def run_all_checks(self) -> List[Dict]:
        ...
        print(f"\n{'='*80}")
        print(f"Production Compliance Checker v2.5 (Unified Value Checking)")
        print(f"{'='*80}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Production-Quality Template Compliance Checker v2.5 (Unified Value Checking)',
